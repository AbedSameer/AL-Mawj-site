...
<body id="body">
    ...
    <div id="contant">
        <section>
            <div class="PageTitle">
                <h1 id="AboutUsTitle"> العناية الدورية </h1>
            </div>
            <div class="wrap">

                <div id="AbouText">
                    <p>
                        نحن نعيش في عصر السرعه ولكن نحتاج ان نستوقف قليلا للاهتمام ببشرتنا، متطلبات الحياة اليومية اصبحت
                        مجهده ومزعجة للبشره
                        لذلك عيادات الموج خصصت قسم للاهتمام بنضارة البشرة وانتزاع الاوساخ والرواسب من على البشره
                        والاهتمام بك سيدتي:
                    </p>
        ...
        <section>
            <div id="face-art">
                <div class="PageTitle">
                    <h1 id="AboutUsTitle"> العناية بالبشرة
                    </h1>
                </div>
                        ...
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                    ...
                                    تنظيف بشرة مع ماسك علاجي حسب نوع البشرة
