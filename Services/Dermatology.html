...
<body id="body">
    ...
    <div id="contant">
        <section>
            <div class="PageTitle">
                <h1 id="AboutUsTitle"> الجلدية</h1>
            </div>
            <div class="wrap">

                <div id="AbouText">
                    <p>
                        قسم الجلدية بعيادات الموج اكثر من مجرد قسم علاجي فإن التزامنا تجاه عملائنا يتخطى <br> الحواجز
                        <br> قسم الجلدية يثقف عملائنا ويوفر لهم مجموعة متنوعة من الحلول و العلاجات الجلدية المتخصصة
                        لمختلف
                        انواع الحالات المرضية
                    </p>
        ...
        <section>
            <div id="face-art">
                <div class="PageTitle">
                    <h1 id="AboutUsTitle">أسئلة شائعة
                        ...
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                    ...
                                    الكي الحار والبارد: يستخدم لإزالة الزوائد الجلدية والثآليل
                                    <i class="fas fa-chevron-down"></i>
                                </button>
                                </button>
                            </h5>
