...
<body id="body">
    ...
    <div id="contant">
        <section>
            <div class="PageTitle">
                <h1 id="AboutUsTitle"> علاجات البشرة </h1>
            </div>
            <div class="wrap">

                <div id="AbouText">
                    <p>
                        عيادات الموج تتفهم ان وجهك يمثل جزء من هويتك لذلك فإن مشاكل البشرة وعلامات تقدم سن البشرة
                        وضعناها من أهم الأولويات
                        لنحاربها بأحدث التقنيات الحائزه على أفضل الجوائز تحت اشراف خبرائنا المتميزين عيادات الموج وفرت
                        مجموعة متنوعة من الاجهزه
                        لعلاج ندبات البشرة وحب الشباب – شد تجاعيد البشرة – إزالة التصبغات - النضارة – اثار الجروح –
        ...
        <section>
            <div id="face-art">
                <div class="PageTitle">
                    <h1 id="AboutUsTitle">ليزر البشرة
                        ...
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                    ...
                                    ant your clients to learn about your business? <i class="fas fa-chevron-down"></i>
                                </button>
                                </button>
                            </h5>
                        </div>
        ...
        <section>
            <div id="face-art">
                <div class="PageTitle">
                    <h1 id="AboutUsTitle"> التقشير وتوحيد اللون
                        ...
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                    ...
                                    التقشير ( كيميائي - تقشير بارد – أحماض الفواكة – ملكي )
                                    <i class="fas fa-chevron-down"></i>
                                </button>
                                </button>
                            </h5>
