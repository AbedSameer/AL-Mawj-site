...
<body id="body">
    ...
    <div id="contant">
        <section>
            <div class="PageTitle">
                <h1 id="AboutUsTitle"> ليزر ازلة الشعر </h1>
            </div>
            <div class="wrap">
        ...
        <section>
            <div id="face-art">
                <div class="PageTitle">
                    <h1 id="AboutUsTitle">خدمات ازالة الشعر
                        ...
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                    ...
                                    جي ماكس<i class="fas fa-chevron-down"></i>
                                </button>
                        ...
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                    ...
                                    دويتو<i class="fas fa-chevron-down"></i>
                                </button>
