...
<body id="body">
    ...
    <div id="contant">
        ...
        <div id="NonSubsicribeClientZone">
            <div>
                <h2 id="NonSubsicribeClientZoneTitle"> منطقة العميل</h2>
                <div id="NonSubsicribeClientZoneLine"></div>
            </div>
            <div id="ClientZone">
                <div id="CliientZoneRight">
                    <div id="ClientZoneImgWrap">
                        <img src="" alt="">
                        <p>azzazazazazzsa@gmail.com</p>
                    </div>
                    <div id="ClientZoneSelect">
                        <select id="tab" size="2">
                            <option id="info" selected class="state">
                                الحالية
                            </option>
                            <option id="addresses" class="state">
                                السابقة
                            </option>
                        </select>
                        <select id="Mobiletab">
                ...
                <div id="CliientZoneLeft">
                    <form method="post">


                        <label for="ClientFirstName">الاسم الاول</label>
                        <input type="text" name="ClientFirstName" id="ClientFirstName" class="ClientInput">



                        <label for="ClientLastName">الاسم الخير</label>
                        <input type="text" name="ClientLastName" id="ClientLastName" class="ClientInput">


                        <label for="ClientPhone">الهاتف</label>
                        <input type="text" name="ClientPhone" id="ClientPhone" class="ClientInput">


                        <label for="ClientContry">الدولة</label>
                        <input type="text" name="ClientContry" id="ClientContry" class="ClientInput">
                        <div>
                            <input type="checkbox" name="update" id="update">
                            <label for="update" id="update">ابقني على علم بآخر التطورات</label>
                        </div>
