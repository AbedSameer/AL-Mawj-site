...
<body id="body">
    ...
    <div id="contant">
        <section>
            <div class="PageTitle">
                <h2 id="AboutUsTitle">جواز سفر الجمال
                </h2>
            </div>
            <div class="wrap" id="beautyPassport">

                <div id="beautyPassportText">
                    <p>
                        BEAUTY PASSPORT
                        <br><br>
                        جواز سفر الجمال هو خيارك الأمثل للتنقل بين فروع مجموعة الموج و التمتع بخصومات ومميزات و عروض
                        حصرية في جميع الأوقات
                        <br><br>
                        المميزات و الخصومات :
                    <ul>
                        <li>

                            خصم 35% على جميع الكشفيات

                        </li>
                        <li>

                            خصم 25% على خدمات التقشير

                        </li>
                        <li>

                            خصم 20% على خدمات الحقن التجميلي

                        </li>
                        <li>

                            خصم 30% على خدمات الليزر

                        </li>
                        <li>
                            خصم 25% على خدمات قسم الاسنان

                        </li>
                        <li>

                            خصم 10% على صيدليات ديار الشاطئ

                        </li>
                        <li>
                            خصم 15 % على خدمات نادي وسبا آساج

                        </li>
                        <li>

                            خصم 15 % على خدمات صالون نوفا

                        </li>
                        <li>

                            مع عروض خاصة تقدم بشكل شهري عن طريق الرسائل أو عن طريق زيارة الصفحة الخاصة بحاملين جواز
                            الجمال
                ...
                <img src="https://static1.s123-cdn-static-a.com/uploads/4858436/800_60682ab9ecb8e.png" alt="Abou us"
                    id="beautyPassportImg">
            </div>

        </section>

        <section id="beautyPassportSecontSection">
            <div id="beautyPassportBackgound"></div>
            <div>
                <h1 class="beautyPassportSecontSectionText">BEAUTY PASSPORT</h1>
                <h3 class="beautyPassportSecontSectionText">جواز سفر الجمال هو خيارك الأمثل</h3>
                <h3 class="beautyPassportSecontSectionText">للتنقل بين فروع مجموعة الموج</h3>
                <a href="#" class="btn btn-light beautyPassportSecontSectionText" target="_blank"
                    rel="noopener noreferrer">اشترك </a>
            </div>
        </section>
