...
<body id="body">
    ...
    <div id="contant">
        <section>
            <div class="PageTitle">
                <h1 id="AboutUsTitle"> خدمات المختبر
                </h1>
            </div>
            <div class="wrap">
        ...
        <section>
            <div id="face-art">
                ...
                <ul>
                    ...
                    <li>مزرعة بول</li>
                    <li>تحليل بول – براز</li>
                    <li>تحليل وظائف الكلى
                    </li>
                    <li>اختبار حساسية
                    </li>
                    <li>تحليل حمل
                    </li>
                    <li>تحليل دهون ثلاثية
                    </li>
                    <li>تحليل فيروسات الكبد
                    </li>
                    <li>تحليل وظائف الكبد
                    </li>
                    <li>تحليل الكولسترول
                    </li>
                    <li>تحليل سرعة الترسيب
                    </li>
                    <li>تحاليل السكر
                    </li>
