...
-->
    ...
    <title>عيادات الموج | خدمات المختبر</title>
</head>
...
<body id="body">
    ...
    <div id="contant">
        <section>
            <div class="PageTitle">
                <h1 id="AboutUsTitle">الصيدلية</h1>
            </div>
            <div class="wrap" id="pharmacyWrap" class="AboutWrap">
                <div id="pharmacyText">
                    <p>
                        صيدليات ديار الشاطئ احدى فروع مجموعة عيادات الموج . وتخدم مجموعة
                        من القطاعات المتنوعة ، في مجال الرعاية الصحية. ويشمل ذلك الأدوية
                        والعناية بالبشرة والجمال والعنايةبالأم و الطفل والمغذيات والرعاية
                        الصحية والعناية الشخصية والتغذية الرياضية والأجهزة الطبية. و بينما
                        نستمر في الحفاظ على اهدافنا في خطط النمو الخاصة بنا ، فإننا نتمسك
                        بقبضة قوية على الاهتمام باحتياجات عملائنا وضمان رضاهم التام عن
                        جميع خدماتنا و منتجاتنا . لأنه بالنسبة لنا ، نحن ناجحون فقط في حال
                        اكتسبنا ثقة ورضا العملاء .
                    </p>
                </div>
                <img src="img/about_us.webp" alt="Abou us" id="pharmacyImg" />
            </div>
        </section>
        ...
        <section>
            <div id="face-art">
                <div class="PageTitle">
                    <h2 id="AboutUsTitle">
                        ماذا تقدم صيدليات ديار الشاطئ لعملاء عيادات الموج ؟
                    </h2>
                </div>

                <div id="pharmacyServeces">
                    <div id="servec">
                        <h3 id="servecTitle">خصم 10% على جميع منتجات الصيدلية</h3>
                        <img src="img/envelope.svg" alt="" id="servesImg" />
                    </div>
                    <div id="servec">
                        <h3 id="servecTitle">شحن مجاني</h3>
                        <img src="img/envelope.svg" alt="" id="servesImg" />
                    </div>
                    <div id="servec">
                        <h3 id="servecTitle">برنامج المكافآت " نقاطي"</h3>
                        <img src="img/envelope.svg" alt="" id="servesImg" />
                    </div>
                    <div id="servec">
                        <h3 id="servecTitle">عروض موسميه متجدده .</h3>
                        <img src="img/envelope.svg" alt="" id="servesImg" />
                    </div>
                </div>
            </div>
                            ...
                            <div id="moreFotter">
                                ...
                                <div id="moreSelectServesesFotter">
                                    ...
                                    <div id="moreMenuServesesFotter">
                                        <ul class="moreMenuList">
                                            <li>
                                                <a href="Services/non-surgical.html">تجميل لا جراحي</a>
                                            </li>
                                            <li><a href="Services/Dermatology.html">الجلدية</a></li>
                                            <li>
                                                <a href="Services/skinLaser.html">ليزر علاج البشرة</a>
                                            </li>
                                            <li>
                                                <a href="Services/laserHair.html">ليزرعلاج الشعر</a>
                                            </li>
                                            <li>
                                                <a href="Services/regularCare.html">العناية الدورية</a>
                                            </li>
                                            <li><a href="Services/dentist.html">طب الاسنان</a></li>
                                            <li><a href="Services/lab.html">المختبر الطبي</a></li>
                                        </ul>
    ...
    <div id="sendEmailPage" class="Alert">
        <label for="showSendEmailPage"> <i class="fas fa-times fa-1x"></i></label>
        <h3>اتصل بنا</h3>
        <h5>setd to <a href="mailto:info@almawj.net">info@almawj.net</a></h5>
        <form method="post">
    ...
    <div id="callUsAlertPage" class="Alert">
        ...
        <a href="tel:920009125">920009125 - للحجز والأستفسار</a>
    </div>
