...
<body id="body">
    ...
    <div id="contant">
        ...
        <div id="NonSubsicribeClientZone">
            ...
            <div id="NonSubsicribeClientZoneCard">
                <h6 id="NonSubsicribeClientZoneCardTitle">رجاءا أدخل بريدك الإلكتروني:</h6>
                <form id="NonSubsicribeClientZoneForm">
                    <input type="text" placeholder="example@wxample.com">
                    <input type="submit" value="اطلب كود الدخول">
                </form>
